              ...
              onPressed: () async {
                ...
                if (mainMuscleGroupsController.text != "") {
                  for (var muscleGroup
                    ...
                    mainMuscleGroups.add(MuscleGroups.fromString(muscleGroup)!);
                  }
                }
                ...
                if (equipmentController.text != "") {
                  for (var equipment in equipmentController.text.split(", ")) {
                ...
                //FileService.exercises().deleteFile();
                ...
                if (exercises
                  ...
                  exercises[exercises.indexWhere(
                          (exercise) => exercise.id == widget.exercise.id)] =
                      widget.exercise;
                  developer.log("Esercizio aggiornato!!!");
                  FileService.exercises().writeFile(jsonEncode(exercises));
                } else {
                  //Non esiste, quindo salvo l'esercizio
                  widget.exercise.id = UniqueKey().hashCode;
                  exercises.add(widget.exercise);
                  final data = jsonEncode(exercises);
                  FileService.exercises().writeFile(data);
                  developer.log("Esercizio salvato!!!");
                }
              },
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, idx) {
                                ...
                                return CheckboxListTile(
                                  ...
                                  value:
                                      selectedMainMuscleGroups.contains(data),
                                  onChanged: (bool? value) {
                                    if (selectedMainMuscleGroups
                                        .contains(data)) {
                                      updateState(() {
                                        selectedMainMuscleGroups.remove(data);
                                      });
                                      setState(() {
                                ...
                                return CheckboxListTile(
                                  ...
                                  onChanged: (bool? value) {
                                    if (selectedSupportMuscleGroups
                                      ...
                                      updateState(() {
                                        selectedSupportMuscleGroups.add(data);
                                      });
                                      setState(() {
                                        supportMuscleGroupsController.text =
                                            FormatList.formatStringList(
